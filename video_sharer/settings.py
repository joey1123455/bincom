"""
Django settings for video_sharer project.
...
ROOT_URLCONF = 'video_sharer.urls'
...
WSGI_APPLICATION = 'video_sharer.wsgi.application'
...
# # print(LINODE_BUCKET_SECRET_KEY)
...
# DEFAULT_FILE_STORAGE = 'video_sharer.storage_backends.PublicMediaStorage'
